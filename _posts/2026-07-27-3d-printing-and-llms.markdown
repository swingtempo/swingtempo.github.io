---
layout: post
title:  "3D Printing and LLMs"
date:   2026-07-27 02:12:01 -0700
categories: ai 3d printing scad
permalink: /3d-printing-and-llms
image: https://lindybeat.net/assets/images/3d-printing-and-llms/ending-image.png
---
...
<div style="display: flex; gap: 16px;">
  <img src="{{ "/assets/images/3d-printing-and-llms/original-handle.jpg" | relative_url }}" alt="Original Handle" style="max-width: 50%; height: auto;">
  <img src="{{ "/assets/images/3d-printing-and-llms/printed-handle.jpg" | relative_url }}" alt="Printed Handle" style="max-width: 50%; height: auto;">
</div>
...
![.scad file snippet]({{ "/assets/images/3d-printing-and-llms/scad-file-example.png" | relative_url }})
...
![Microsoft Loop logo]({{ "/assets/images/3d-printing-and-llms/loop-logo.png" | relative_url }})
...
<div style="display: flex; gap: 16px;">
  <img src="{{ "/assets/images/3d-printing-and-llms/red-3d-logo.png" | relative_url }}" alt="Red 3d logo" style="max-width: 50%; height: auto;">
  <img src="{{ "/assets/images/3d-printing-and-llms/purple-3d-logo.png" | relative_url }}" alt="Purple 3d logo" style="max-width: 50%; height: auto;">
</div>
...
![Ending image]({{ "/assets/images/3d-printing-and-llms/ending-image.png" | relative_url }})